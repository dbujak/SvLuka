<%@ Page language="c#" validateRequest=false Codebehind="Sorry.aspx.cs" AutoEventWireup="True" Inherits="SvLuka.Donations.Sorry" %>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" height="100%" cellSpacing="0" cellPadding="0" width="100%" border="0">
				...
				<TR>
					...
					<TD vAlign="top">
						<P>
							<asp:label id="lblSorry" runat="server">Sorry</asp:label></P>
					</TD>
					<TD vAlign="top"></TD>
					<TD vAlign="top">
