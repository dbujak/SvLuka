<%@ Page language="c#" Codebehind="PrayerRopes.aspx.cs" AutoEventWireup="True" Inherits="SvLuka.Teens.PrayerRopes" %>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" height="100%" cellSpacing="0" cellPadding="0" width="100%" border="0">
				...
				<TR>
					<TD vAlign="top"></TD>
					<TD vAlign="top">
						<asp:Label id="lblRopes" runat="server">Prayer Ropes</asp:Label></TD>
					<TD vAlign="top"></TD>
					<TD vAlign="top">
