...
<%@ Page language="c#" Codebehind="default.aspx.cs" AutoEventWireup="True" Inherits="SvLuka.Newsletter._default" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>Publications / Publikacije</title>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" height="100%" cellSpacing="0" cellPadding="0" width="100%" border="0">
				...
				<TR>
					<TD vAlign="top"></TD>
					<TD vAlign="top">
						<asp:Label id="lblPublications" runat="server">Publications</asp:Label></TD>
					<TD vAlign="top"></TD>
					<TD vAlign="top">
