<%@ Page language="c#" Codebehind="reportNews.aspx.cs" AutoEventWireup="True" Inherits="SvLuka.Newsletter.reportNews" %>
...
<HTML>
	<HEAD>
		<title>Let us know / Posaljite nam novosti</title>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" height="100%" cellSpacing="0" cellPadding="0" width="100%" border="0">
				...
				<TR>
					<TD vAlign="top"></TD>
					<TD vAlign="top">
						<asp:Label id="lblLetUsKnow" runat="server">Let us know</asp:Label></TD>
					<TD vAlign="top"></TD>
					<TD vAlign="top">
