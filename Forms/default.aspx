<%@ Page language="c#" Codebehind="default.aspx.cs" AutoEventWireup="True" Inherits="SvLuka.Forms._default" %>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table3" height="100%" cellSpacing="0" cellPadding="0" width="100%" border="0">
				...
				<TR>
					...
					<TD vAlign="top">
						<P align="left">
							<asp:Label id="lblForms" runat="server">Forms</asp:Label></P>
						<P></P>
					</TD>
					<TD vAlign="top"></TD>
					<TD vAlign="top">
